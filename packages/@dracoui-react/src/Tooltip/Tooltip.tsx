...
import { Fragment, forwardRef, useRef, useMemo, useState, useEffect } from 'react';
...
export const Tooltip = forwardRef<HTMLElement, TooltipProps & VariantProps<typeof tooltipVariants>>(
  (
